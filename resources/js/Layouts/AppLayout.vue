        ...
        <nav class="bg-white">
                ...
                <div class="flex justify-between h-24">
                    ...
                    <div class="flex">
                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                            ...
                            <!-- <NavLink v-if="$page?.props?.auth?.user?.rol === 'admin'" :href="route('Admin.Index')" :active="route().current('Admin.Index')"> Administrador </NavLink> -->
                            <!-- <NavLink v-if="$page?.props?.auth?.user?.rol === 'medic'" :href="route('Medic.Index')" :active="route().current('Medic.Index')"> Médico </NavLink> -->
                            ...
                            <NavLink v-if="$page?.props?.auth" :href="route('login')" :active="route().current('login')"> Iniciar sesión </NavLink>
                            <NavLink v-if="$page?.props?.auth" :href="route('register')" :active="route().current('register')"> Registro </NavLink>
                            <NavLinkLogout v-if="$page?.props?.auth" :active="route().current('logout')"> Cerrar sesión </NavLinkLogout>
                        </div>
                        <div v-if="!$page?.props?.auth" class="hidden sm:flex sm:items-center sm:ms-6">
            ...
            >
                <div class="pt-2 pb-3 space-y-1">
                    ...
                    <responsive-nav-link v-if="$page?.props?.auth?.user?.rol === 'medic'" :href="route('Medic.History')" :active="route().current('Medic.History')"> Buscar Historial Clínico </responsive-nav-link>
