<template>
    <AppLayout title="Dashboard">
        <template #header>
            <h2 class="flex justify-center font-semibold text-xl text-gray-800 leading-tight">DESARROLLO DEL PROTOCOLO PARA EL ESTUDIO DE PARTICIPANTES</h2>
        </template>
            ...
            <div v-if="values" class="mt-4">
                <div class="overflow-x-auto">
                    <div class="p-4">
                        ...
                        <!--clinic_histories-->
                        <div class="mb-4">
                            <ButtonCustom class="w-full h-full" mode="button" @click="isDropdownClinicHistoriesOpen == false ? (isDropdownClinicHistoriesOpen = true) : (isDropdownClinicHistoriesOpen = false)">Historia Clínica</ButtonCustom>
                        ...
                        <!--WORK ACTIVITIES-->
                        <div class="mb-4">
                            <ButtonCustom class="w-full h-full" mode="button" @click="isDropdowWorkActivitiesOpen == false ? (isDropdowWorkActivitiesOpen = true) : (isDropdowWorkActivitiesOpen = false)">Actividades Laborales</ButtonCustom>
                        ...
                        <!--Escolaridad-->
                        <div class="mb-4">
                            <ButtonCustom class="w-full h-full" mode="button" @click="isDropdownScholarshipsOpen == false ? (isDropdownScholarshipsOpen = true) : (isDropdownScholarshipsOpen = false)">Escolaridad</ButtonCustom>
                        ...
                        <div class="mb-4">
                            <ButtonCustom class="w-full h-full" mode="button" @click="isDropdownOpen == false ? (isDropdownOpen = true) : (isDropdownOpen = false)">Eventos cardiovasculares</ButtonCustom>
                        ...
                        <div class="mb-4">
                            <ButtonCustom class="w-full h-full" mode="button" @click="isDropdownPatologicalOpen == false ? (isDropdownPatologicalOpen = true) : (isDropdownPatologicalOpen = false)">Antecedentes patológicos</ButtonCustom>
                        ...
                        <!--surgicals-->
                        <div class="mb-4">
                            <ButtonCustom class="w-full h-full" mode="button" @click="isDropdownSurgicalsOpen == false ? (isDropdownSurgicalsOpen = true) : (isDropdownSurgicalsOpen = false)">Antecedentes quirúrgicos</ButtonCustom>
                        ...
                        <div class="mb-4">
                            <ButtonCustom class="w-full h-full" mode="button" @click="isDropdownTraumaticsOpen == false ? (isDropdownTraumaticsOpen = true) : (isDropdownTraumaticsOpen = false)">Antecedentes traumáticos</ButtonCustom>
                        ...
                        <div class="mb-4">
                            <ButtonCustom class="w-full h-full" mode="button" @click="isDropdownToxicsOpen == false ? (isDropdownToxicsOpen = true) : (isDropdownToxicsOpen = false)">Antecedentes tóxicos</ButtonCustom>
                        ...
                        <!--Medicamentos:-->
                        <div class="mb-4">
                            <ButtonCustom class="w-full h-full" mode="button" @click="isDropdownMedicinesOpen == false ? (isDropdownMedicinesOpen = true) : (isDropdownMedicinesOpen = false)">Medicamentos</ButtonCustom>
                        ...
                        <!--paraclinicals. -->
                        <div class="mb-4">
                            <ButtonCustom class="w-full h-full" mode="button" @click="isDropdownParaclinicalsOpen == false ? (isDropdownParaclinicalsOpen = true) : (isDropdownParaclinicalsOpen = false)">Paraclínicos</ButtonCustom>
                        ...
                        <!--relatives-->
                        <div class="mb-4">
                            <ButtonCustom class="w-full h-full" mode="button" @click="isDropdownRelativesOpen == false ? (isDropdownRelativesOpen = true) : (isDropdownRelativesOpen = false)">Antecedentes Familiares</ButtonCustom>
                ...
                <div class="flex justify-center w-1/3 items-center mx-auto mt-10">
                    <ButtonCustom class="w-full mx-auto" mode="button" @click="saveInformation">GUARDAR HISTORIA CLÍNICA</ButtonCustom>
                </div>
            </div>
        </div>
        <div v-if="succesSave" class="flex justify-center bg-green-500 border border-green-200 text-white px-4 py-3 rounded relative" role="alert">
...
const search = async () => {
    if (identification.value == '') {
        errorMessage.value = 'Debe ingresar una identificación';
        ...
        if (response.data == 'No se encontro el usuario') {
            errorMessage.value = 'No se encontró un usuario con esa identificación';
            errorPoint.value = true;
            return;
        } else {
