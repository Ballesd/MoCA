            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-4 md:p-8">
                    ...
                    <div v-if="values" class="mt-8">
                        ...
                        <div class="body flex justify-end items-center pr-4"> <!-- Se eliminó bg-blue-100 para quitar el color de fondo -->
                            <div class="flex justify-end">
                                <button @click="downloadExcel" class="download-button transform active:scale-95 bg-green-500 hover:bg-green-400 text-white px-4 py-2 rounded-lg font-bold tracking-widest transition duration-150 ease-in-out shadow-md">
                                    <div class="flex justify-center items-center relative">
                                        ...
                                        <div class="button-copy pl-2 leading-none uppercase">Descargar Excel</div>
                                    </div>
                                </button>
                            </div>
                        </div>
