    ...
    <AuthenticationCard>
        ...
        <form @submit.prevent="submit">
            ...
            <div class="mt-4">
                <InputLabel
                    for="email"
                    value="Correo electrónico (puede ser de un familiar en caso de no tener uno propio)"
                />
                <TextInput
                    id="email"
                    v-model="form.email"
            ...
            <div class="mt-4">
                ...
                <InputError
                    class="mt-2"
                    :message="form.errors.identification"
                />
            </div>
            ...
            <div class="mt-4">
                <InputLabel
                    for="schooling"
                    value="¿Su nivel de escolaridad es menor o igual a 12 años?:"
                />
                <select
                    id="schooling"
                ...
                >
                    <option value="0">
                        No, tengo más de 12 años de estudio.
                    </option>
                    <option value="1">
                        Sí, tengo menos de 12 años o igual.
                    </option>
                </select>
            ...
            <div class="mt-4">
                ...
                <InputError
                    class="mt-2"
                    :message="form.errors.birthday_place"
                />
            </div>
            ...
            <div class="mt-4">
                ...
                <div class="flex items-center">
                    <input
                        id="civil_status_soltero"
                        type="radio"
                        v-model="form.civil_status"
                        value="soltero"
                        name="civil_status_soltero"
                        class="w-4 h-4 text-blue-600 focus:ring-blue-500 focus:ring-2"
                    />
                ...
                <div class="flex items-center mb-4">
                    <input
                        id="civil_status_casado"
                        v-model="form.civil_status"
                        type="radio"
                        value="casado"
                        name="civil_status_casado"
                        class="w-4 h-4 text-blue-600 focus:ring-blue-500 focus:ring-2"
                    />
                ...
                <div class="flex items-center mb-4">
                    <input
                        id="civil_status_separado"
                        v-model="form.civil_status"
                        type="radio"
                        value="separado"
                        name="civil_status_separado"
                        class="w-4 h-4 text-blue-600 focus:ring-blue-500 focus:ring-2"
                    />
                ...
                <div class="flex items-center">
                    <input
                        id="civil_status_union_libre"
                        type="radio"
                        v-model="form.civil_status"
                        value="union_libre"
                        name="civil_status_union_libre"
                        class="w-4 h-4 text-blue-600 focus:ring-blue-500 focus:ring-2"
                    />
                ...
                <div class="flex items-center">
                    <input
                        id="civil_status_viudo"
                        type="radio"
                        v-model="form.civil_status"
                        value="viudo"
                        name="civil_status_viudo"
                        class="w-4 h-4 text-blue-600 focus:ring-blue-500 focus:ring-2"
                    />
