                ...
                <div class="w-full h-full p-10 bg-quinary shadow-md sm:rounded-3xl border border-gray-400 overflow-y-scroll">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <select id="schooling" v-model="form.civil_status" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                ...
                <div class="flex items-center justify-center mt-5">
                    <div class="flex flex-col items-center justify-center space-y-4">
                        <div class="flex items-center justify-center space-x-2">
                            ...
                            <Link :href="route('login')" class="underline text-sm text-gray-400 hover:text-gray-600 rounded-md focus:outline-none"> INICIA SESIÓN AQUÍ </Link>
                        </div>
                        <ButtonCustom class="" :class="{ 'opacity-25': form.processing }" :disabled="form.processing" :onclick="submit"> REGISTRARME </ButtonCustom>
                    </div>
                </div>
            </div>
        </div>
